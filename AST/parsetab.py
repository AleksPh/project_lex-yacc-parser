...
_lr_productions = [
  ...
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','new_parser.py',7),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','new_parser.py',8),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','new_parser.py',9),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','new_parser.py',10),
  ('expression -> expression EXPONENT expression','expression',3,'p_expression_binop','new_parser.py',11),
  ('expression -> NUMBER','expression',1,'p_expression_number','new_parser.py',15),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_paren','new_parser.py',19),
  ('expression -> IDENTIFIER','expression',1,'p_expression_var','new_parser.py',23),
]
